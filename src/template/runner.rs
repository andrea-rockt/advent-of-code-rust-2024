...
pub fn run_part<I: Clone, T: Display>(func: impl Fn(I) -> Result<T, String>, input: I, day: Day, part: u8) {
...
fn print_result<T: Display>(result: &Result<T, String>, part: &str, duration_str: &str) {
